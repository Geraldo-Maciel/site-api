...
class AdmHomeTopoImgController {    
    ...
    async show(req, res) {
        ...
        _Home2.default.findOne({}, "_id topOriginalName topFileName").then((home) => {
    ...
    async update(req, res) {
        ...
        await _Home2.default.findOne({ _id: req.body._id }, '_id topFileName').then((home) => {
...
exports. default = new AdmHomeTopoImgController();