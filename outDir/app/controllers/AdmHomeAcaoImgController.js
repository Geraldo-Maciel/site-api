...
class AdmHomeAcaoImgController {    
    ...
    async show(req, res) {
        ...
        _Home2.default.findOne({}, "_id acaoOriginalName acaoFileName").then((home) => {
    ...
    async update(req, res) {
        ...
        await _Home2.default.findOne({ _id: req.body._id }, '_id acaoFileName').then((home) => {
...
exports. default = new AdmHomeAcaoImgController();