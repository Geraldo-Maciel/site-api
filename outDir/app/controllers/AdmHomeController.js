"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }var _config = require('../../config/config'); var _config2 = _interopRequireDefault(_config);
...
class AdmHomeController {
    ...
    async store(req, res) {
        ...
        const homeExiste = await _Home2.default.findOne({});
        if (homeExiste) {
            return res.status(400).json({
                error: true,
                code: 103,
        ...
        await _Home2.default.create(dados, (err) => {
...
exports. default = new AdmHomeController();